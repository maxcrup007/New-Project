<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ErrandleaveReport.aspx.cs" Inherits="ErrandleaveReport" EnableSessionState="ReadOnly" %>
...
<body>
    <form id="form1" runat="server">
        <div align = 'center'>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ReportingConnectionString6 %>" SelectCommand="SELECT * FROM [Table_Reportingerrandleave]"></asp:SqlDataSource>
            <br />
